...
import VariousBalls.videoTape_Preview_Oracle;

public class BasketTapeServlet extends HttpServlet {
   ...
   // private JSONArray array1=new JSONArray();//用于保存视频预览中的数据
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			videoID=obj.readInt();
			obj.close();
			Basket_Tape_Preview_Oracle conn=new Basket_Tape_Preview_Oracle(videoID);
			jo=conn.getInfo();
