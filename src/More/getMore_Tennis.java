...
public class getMore_Tennis {
	  ...
	  //select t.videoid,totalduration,videofile,videoaddr,videodatecome,videoname ,clickNum from VOLLEY_VIDEO t, VOLLEY_VIDEO_DYNAMIC t1 where t.videoid=t1.videoid
		  ...
		  try  
	       {   Class.forName("oracle.jdbc.driver.OracleDriver");
	          ...
	          rs1=stmt.executeQuery("select count(*)from  Tennis_VIDEO t ,Tennis_VIDEO_DYNAMIC t1 where t.videoid=t1.videoid");
	          while(rs1.next()){
	           total=Integer.valueOf( rs1.getObject(1).toString());//用于统计个数
	          }
	          j1.put("total", total);
	          rs=stmt.executeQuery("select * from (select row_number() over(order by videodatecome desc) r,t.videoorigin, t.videoid,totalduration,videofile,videoaddr,videodatecome,videoname ,clickNum from Tennis_VIDEO t, Tennis_VIDEO_DYNAMIC t1 where t.videoid=t1.videoid)"
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		   getMore_Tennis t=new getMore_Tennis() ;
